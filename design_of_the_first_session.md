...
[Глава 1. Теоретические основы продуктового менеджмента](#глава-1-теоретические-основы-продуктового-менеджмента)

[1.1	Что такое конверсия, зачем ее оценивать, и как влиять](#11-что-такое-конверсия-зачем-ее-оценивать-и-как-влиять)

[1.2	Методы проверки гипотез. Исследование аудитории](#12-методы-проверки-гипотез-исследование-аудитории)

[1.3 Зачем и как проводить анализ конкурентов](#13-зачем-и-как-проводить-анализ-конкурентов)

[1.4 CJM и UJM. Для чего составлять карту пути пользователя](#14-cjm-и-ujm-для-чего-составлять-карту-пути-пользователя)

[1.5 Что такое User Story и Job Story](#15-что-такое-user-story-и-job-story)

[1.6 Продуктовые гипотезы и их приоритизация](#16-продуктовые-гипотезы-и-их-приоритизация)

[1.7 Как протестировать гипотезу решения](#17-как-протестировать-гипотезу-решения)

[Глава 2. Проведение исследований и обработка результатов](#глава-2-проведение-исследований-и-обработка-результатов)

[2.1 Исследование проблемы низкой конверсии](#21-исследование-проблемы-низкой-конверсии)

[2.2 Исследование нелояльной аудитории](#22-исследование-нелояльной-аудитории)

[2.3 Анализ функционала сервисов-конкурентов](#23-анализ-функционала-сервисов-конкурентов)

[2.4 Customer Jorney Map и User Jorney Map](#24-customer-jorney-map-и-user-jorney-map)

[2.5 Формирование гипотез решения на основании Job Story](#25-формирование-гипотез-решения-на-основании-job-story)

[2.6 Приоритизация гипотез](#26-приоритизация-гипотез)

[2.7 Создание прототипа, иллюстрирующего решение](#27-создание-прототипа-иллюстрирующего-решение)

[2.8 Тестирование и обработка результатов](#28-тестирование-и-обработка-результатов)
...
[Приложение 1. CJM](#приложение-1-cjm)
...
[Ссылка на прототип](https://clck.ru/35UTf4)
